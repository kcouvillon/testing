document.onreadystatechange = function () {
	'use strict';
	if( window.location.href.indexOf('ie-fallback') === -1 ) {
		window.location.href = '/ie-fallback/';
	}

    if (document.readyState === "complete") {
	var iediv = document.createElement('<div id="iediv"></div>');
	var iebgimg = document.createElement('<img id="iebgimg">');
	...
	iebgimg.src = '/wp-content/themes/worldstrides/assets/images/worldstrides-ie-fallback.png';
	document.body.insertBefore(iebgimg, document.body.firstChild);
	...
	if( ieversion && ieversion === 8 ) {
		...
		document.querySelectorAll('.footer-logo')[0].style.display = 'none';
		document.querySelectorAll('.footer-navigation')[0].style.display = 'none';
		document.querySelectorAll('.site-info')[0].style.display = 'none';
	}
