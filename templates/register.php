 ...
 *
 * This is the general template for the Register page. Make sure this page is selected from the template drop down
 */
get_header(); ?>
...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		...
		<?php get_template_part( 'partials/register', 'header' ); ?>
