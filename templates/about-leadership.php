        ...
        <main id="main" class="site-main" role="main">
            ...
            <section class="section-content leadership-content">
                ...
                <div class="col-md-4" style="text-align: center">
                    <img id="org-img" style="width: 25%" src="<?php echo site_url(); ?>/wp-content/uploads/2016/05/icon_lead_exec_on.png" />
                    <div id="group1" class="btn btn-primary btn-leadership">Organization</div>
                </div>
                <div class="col-md-4" style="text-align: center">
                    <img id="reg-img" style="width: 25%" src="<?php echo site_url(); ?>/wp-content/uploads/2016/05/icon_lead_geo_on.png" />
                    <div id="group2" class="btn btn-primary btn-leadership">Programs & Regions</div>
                </div>
                <div class="col-md-4" style="text-align: center">
                    <img id="sup-img" style="width: 25%" src="<?php echo site_url(); ?>/wp-content/uploads/2016/05/icon_lead_support_on.png" />
