<div class="itinerary-pricing ws-container clearfix">
	...
	<form id="tour-pricing-form" class="ws-form tour-pricing-form" method="post" action="#">
		<ul class="list-unstyled clearfix">
			...
			<footer class="pricing-form-footer">
	...
	<div class="tour-pricing-content clearfix">

		<script id="tour-pricing-template" type="x-tmpl-mustache">

			<form id="tour-options-form" class="tour-options">
				<ul class="list-unstyled">
					...
					<li>
						...
						<ul class="list-unstyled">
							{{#options}}
							<li>
								<input type="checkbox" name="option_form{{optionKey}}" id="option_form{{optionKey}}" />&nbsp;
								<label for="option_{{sName}}">{{name}}</label>
			...
			<div class="tour-quote">
				<ul class="list-unstyled">
					<li class="total-cost">
						<h4>Total Cost <span class="pull-right">${{total}}</span></h4>
					...
					<li class="cost-breakdown">
						...
						<ul class="list-unstyled">
							{{#quotes}}
							<li>{{name}} <span class="pull-right">${{price}}</span></li>
							{{/quotes}}
							<li class="highlight">Early enrollment discount <span class="pull-right">-${{earlyDiscount}}</span></li>
					...
					<li class="ways-to-save">
						...
						<ul class="list-unstyled">
							<li class="even">
								<div class="item-title"><strong>Early Enrollment Discount</strong>&nbsp;&nbsp;<a href="#details-early-enroll" class="slide-toggle">Details</a></div>
								<div id="details-early-enroll" class="details" style="display: none;">
									Students who enroll on this tour on or before {{earlyDiscountDate}} will receive a savings of ${{earlyDiscount}}. Students who enroll after this date will not receive the savings.<br/>
									Please note: This savings has already been added to your quote (see line above in blue).
								</div>
							</li>
							<li class="odd">
								<div class="item-title"><strong>Private Bus For Your Group</strong>&nbsp;&nbsp;<a href="#details-private-bus" class="slide-toggle">Details</a></div>
								<div id="details-private-bus" class="details" style="display: none;">
									Enroll 30 students by 10/01/2015 for tours departing on or after 3/1/16 and you&apos;ll receive your own private bus for your group.
								</div>
							</li>
						</ul>
					</li>
